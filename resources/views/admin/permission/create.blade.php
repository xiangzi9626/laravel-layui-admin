    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" lay-reqtext="权限名称不能为空" placeholder="权限名称" autocomplete="off" class="layui-input">
            </div>
        </div>
...
/*        form.verify({
        ...
        form.on('submit(submit)', function(data){
            $.ajax({
                url: "/admin/permissions/createSubmit",
                method : 'POST',
                data:data.field,
                dataType: "json",
