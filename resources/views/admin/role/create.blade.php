    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" lay-reqtext="角色名称不能为空" placeholder="角色名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                @foreach($perList as $list)
                <input type="checkbox" name="permission[{{$list->id}}]" title="{{$list->name}}({{$list->description}})">
                @endforeach
            </div>
        </div>
        @endif
