...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-sm" lay-event="addUser">添加专题</button>
    </div>
</script>
...
<script>
    layui.use(['table','form'], function(){
        ...
        table.on('edit(test)', function(obj){
            ...
            if(value==null ||value==''){
                layer.msg('专题标题不能修改为空');
                // table.reload('test')
            }
            $.ajax({
                url: "/admin/topics/edit",
                method : 'POST',
                data:{
        ...
        table.on('toolbar(test)', function(obj){
            ...
            switch(obj.event){
                case 'addUser':
                    x_all_show('添加','/admin/topics/create',"600","300");
                    break;
                case 'getCheckLength':
        ...
        table.on('tool(test)', function(obj){
            var data = obj.data;
            if(obj.event === 'del'){
                layer.confirm('确认删除该专题？', function(index){
                    var url = '/admin/topics/delete/'+data.id;
                ...
                var url = '/admin/topics/create';
                x_all_show('添加',url);
            }else if(obj.event === 'isShow'){
                var url = '/admin/topics/'+data.id+'/edit';
                console.log(url);
                x_all_show('添加',url);
            }
        });
        ...
        form.on('switch(isShow)', function (data) {
            ...
            var id = $(this).data('id');
            var url = '/admin/topics/changeStatus/'+id;
            $.ajax({
                url:url,
                method:"post",
                dataType:'json',
