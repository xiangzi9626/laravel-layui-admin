    ...
    <li class="dropdown">
        <div>
            ...
            @else
                ...
                <a href="/login" class="blog-nav-item dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">请登录<span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="/login">我的主页</a></li>
                    <li><a href="/login">个人设置</a></li>
                </ul>
            @endif
        </div>
    </li>
